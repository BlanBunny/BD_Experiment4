...
df_train = pd.read_csv(r'"D:\Software\Ubuntu\ubuntu_share\Experiment4\train_format1.csv"')
df_test = pd.read_csv(r'"D:\Software\Ubuntu\ubuntu_share\Experiment4\test_format1.csv"')
user_info = pd.read_csv(r'"D:\Software\Ubuntu\ubuntu_share\Experiment4\user_info_format1.csv"')
user_log = pd.read_csv(r'"D:\Software\Ubuntu\ubuntu_share\Experiment4\No1.1\user_log_format1.csv')
